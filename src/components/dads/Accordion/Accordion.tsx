  ...
  return (
    <summary
      className={`
        ...
        marker:[content:'']
        hover:bg-solid-gray-50 focus-visible:rounded-4 focus-visible:bg-yellow-300 focus-visible:outline focus-visible:outline-4
        focus-visible:outline-offset-[calc(2/16*1rem)] focus-visible:outline-black focus-visible:ring-[calc(2/16*1rem)] focus-visible:ring-yellow-300
    ...
    >
      <span
        className={`
          absolute top-2 left-0.5 inline-flex items-center justify-center size-[var(--icon-size)] mt-[calc((1lh-var(--icon-size))/2)]
          border border-current bg-white text-blue-1000 rounded-full
  ...
  return (
    <a
      className={`
        ...
        focus-visible:rounded-4 focus-visible:outline focus-visible:outline-4 focus-visible:outline-black focus-visible:outline-offset-[calc(2/16*1rem)]
        focus-visible:bg-yellow-300 focus-visible:text-blue-1000 focus-visible:ring-[calc(2/16*1rem)] focus-visible:ring-yellow-300
        ${className ?? ''}
      `}
      href={href}
      {...rest}
